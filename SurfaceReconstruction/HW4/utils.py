...
def sample(inputs, local_sigma, global_sigma):
    ...
    global_sample = (torch.rand(samlpe_size // 8, dim, device=inputs.device) * (global_sigma * 2)) - global_sigma # 生成元素大小在[-global_sigma, global_sigma]范围内的张量，8是经验参数，控制全局采样点数不太多，提高训练效率
